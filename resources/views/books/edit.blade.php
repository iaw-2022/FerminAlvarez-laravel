            ...
            <form action="/book/{{$book->ISBN}}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        onkeyup="this.value=this.value.replace(/[^\d]/,'')" value="{{$book->ISBN}}">
                    </div>
                    <div class="col-md-6">
                                            ...
                                            <tr class="text-center">
                                                <td>
                                                    @if ($book->authors->contains($author))
                                                        <input type="checkbox" class="custom-control-input" id="customCheck1" name="authors[]" value="{{$author->id}}" checked>
                                                    @else
                                                        <input type="checkbox" class="custom-control-input" id="customCheck2" name="authors[]" value="{{$author->id}}">
                                                    @endif
                                                    </div>
                                                </td>
